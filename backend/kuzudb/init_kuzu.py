...
""" load data in db"""
"""---------------- nodes --------------------------------------------------------------------"""
conn.execute('COPY Author FROM "kuzu_db/data/nodes_authors.csv" (DELIM=";")')
conn.execute('COPY AuthorCS FROM "kuzu_db/data/nodes_authors_csrankings.csv" (DELIM=";")')
conn.execute('COPY Proceeding FROM "kuzu_db/data/nodes_proceedings.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Inproceeding FROM "kuzu_db/data/nodes_inproceedings.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Conference FROM "kuzu_db/data/nodes_conferences.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Institution FROM "kuzu_db/data/nodes_institution.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Country FROM "kuzu_db/data/nodes_countries.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Region FROM "kuzu_db/data/nodes_regions.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY Area FROM "kuzu_db/data/nodes_area.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY SubArea FROM "kuzu_db/data/nodes_sub_area.csv" (DELIM=";", HEADER=true)')
"""---------------- edges --------------------------------------------------------------------"""
conn.execute('COPY Collaboration FROM "kuzu_db/data/edges_collabs.csv" (DELIM=";", HEADER=true)')
conn.execute('COPY CollaborationCS FROM "kuzu_db/data/edges_collabs_csrankings.csv" (DELIM=";")')
conn.execute('COPY Affiliation FROM "kuzu_db/data/edges_affiliated.csv" (DELIM=";")')
conn.execute('COPY AffiliationCS FROM "kuzu_db/data/edges_affiliated.csv" (DELIM=";")')
conn.execute('COPY Crossref FROM "kuzu_db/data/edges_crossref.csv" (DELIM=";")')
conn.execute('COPY BelongsToConf FROM "kuzu_db/data/edges_belongs_to_conf.csv" (DELIM=";")')
conn.execute('COPY BelongsToArea FROM "kuzu_db/data/edges_belongs_to_area.csv" (DELIM=";")')
conn.execute('COPY SubAreaOf FROM "kuzu_db/data/edges_sub_area_of.csv" (DELIM=";")')
conn.execute('COPY InRegion FROM "kuzu_db/data/edges_in_region.csv" (DELIM=";")')
conn.execute('COPY LocatedIn FROM "kuzu_db/data/edges_located_in.csv" (DELIM=";")')
